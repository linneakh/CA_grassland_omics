...
source("../../scripts/PLSR-functions-reverse.R")
...
# Usage example with actual object names from earlier:
 p_list <- list(
   ...
   make_correlation_plots_with_legend(ratio_df, y_label ="ratio") + ggtitle("Biosyn:Energy ratio")
 )
#
data_list <- list(
  d_bio_aa,
...
ggsave(file.path(out_dir, "CGE_vs_expression_grid_10_reverse.png"), plot = final_plot, width = 14, height = 10, units = "in", dpi = 300)
ggsave(file.path(out_dir, "CGE_vs_expression_grid_10_reverse.pdf"), plot = final_plot, width = 14, height = 10, units = "in", dpi = 300)
