...
#Import raw data and format raw data for analysis:
  ...
  data.all <- read.table("./data/ASV_table_relabun_50percent_with_sample_info_total_copies.txt", header=T, sep="\t", stringsAsFactors=T, check.names=F) #Note that this input has total copies of 16S in original binned SIP fractions to account for the different volumes - See line 435 for further explanation
  summary(data.all)
  head(data.all)
  names(data.all)
  dim(data.all)
...
#Calculate mass (copies/ul of each taxon) of DNA per fraction, based on relative abundance (relative coverage) and total amount of DNA (ng) per fraction:
...
#Import soil extraction data with mass of soil represented by the DNA in each tube:
  ...
  write.table(data.melted.3, paste(Dir.o, "SB_data-melted-3_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(data.melted.24, paste(Dir.o,"SB_data-melted-24_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(data.melted.48, paste(Dir.o,"SB_data-melted-48_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(data.melted.72, paste(Dir.o,"SB_data-melted-72_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(data.melted.168, paste(Dir.o,"SB_data-melted-168_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  
  write.table(copies.tube.melted.3, paste(Dir.o,"SB_copies-tubes-melted-3_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(copies.tube.melted.24, paste(Dir.o,"SB_copies-tubes-melted-24_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(copies.tube.melted.48, paste(Dir.o,"SB_copies-tubes-melted-48_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(copies.tube.melted.72, paste(Dir.o,"SB_copies-tubes-melted-72_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  write.table(copies.tube.melted.168, paste(Dir.o,"SB_copies-tubes-melted-168_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
...
#Write the results (all.comparisons.3) to a text file:
  ...
  write.table(all.comparisons.3, paste(Dir.o,"SB_3hour_all_comparisons_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)


#Write the taxa.id dataframe to a text file:
  write.table(taxa.id, paste(Dir.o,"SB_taxa_ID_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
...
#Write the results (all.comparisons.24) to a text file:
  write.table(all.comparisons.24, paste(Dir.o,"SB_24hour_all_comparisons_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
  ...
  write.table(all.comparisons.48, paste(Dir.o, "SB_48hour_all_comparisons_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
...
#Write the results (all.comparisons.72) to a text file:
  write.table(all.comparisons.72, paste(Dir.o, "SB_72hour_all_comparisons_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
...
#Write the results (all.comparisons.168) to a text file:
  write.table(all.comparisons.168, paste(Dir.o, "SB_168hour_all_comparisons_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
...
#Write the combined results (all.comparisons) to a text file:
  write.table(all.comparisons, paste(Dir.o, "SB_all_comparisons_50percent.txt", sep=""), append=F, quote=F, sep="\t", eol="\n", na="NA", dec=".", row.names=F, col.names=T)
...
#Save workspace:
  save(list=ls(all.names=TRUE), file="./qSIP_workspaces/50_SB_01.RData", envir=.GlobalEnv)
