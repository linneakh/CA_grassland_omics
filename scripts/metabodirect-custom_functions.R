...
# Modified by Linnea Hernandez 11/5/24 (honeker1@llnl.gov)
# 
# ***************************************************************

# Additional data ----
colors.class.2 = c("chartreuse3","#F7941D","darkseagreen1",
                   "#C4A484","black","#6D6E71","yellow",  "darkorchid")
