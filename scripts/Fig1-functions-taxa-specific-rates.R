...
#create function for mortality rates with fixed y axis set to 50% mortality rate
bar_plot_d_fixed_short <- function(rate_file){
...
#create function for growth rates with fixed y axis set to max growth rate
...
#create function for mortality rates with fixed y axis set to 100% max mortality rate
