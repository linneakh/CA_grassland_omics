...
source("../scripts/functions/Fig1-functions-taxa-specific-rates.R")
...
tax.0 <- read.delim("../data/taxonomy_table_reads.txt", sep = "\t", header = FALSE)
tax <- tax.0 |>
...
#50 and 100, death rates bar plots
plot.bar.d_fixed_short <- bar_plot_d_fixed_short(rates.b.d.f.long)
plot.bar.d_fixed_short
ggsave(paste(Dir.f,"bar_50_100_d_f_new_Filter_fixed_short.png", sep = ""), width = 10, height = 5, units = "in", dpi = 300)
ggsave(paste(Dir.f,"bar_50_100_d_f_new_Filter_fixed_short.pdf", sep = ""), width = 10, height = 5, units = "in", dpi = 300)
